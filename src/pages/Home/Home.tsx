    ...
    <div className="min-h-screen bg-main text-white">
      ...
      <motion.section className="bg-main text-white py-24 px-6 relative" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
        <div className="container mx-auto text-center">
          ...
          <Link to="/signup">
            <Button label="Créer un compte" className="m-auto w-44 bg-yellow-50 text-main font-semibold px-6 py-3 rounded-lg shadow-md hover:bg-white/80 transition-all" />
          </Link>
        </div>
      </motion.section>
    </div>
